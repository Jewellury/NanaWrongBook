...
export const seedItems: SeedItem[] = [
  ...
  { nodeId: "M1-04", role: "variant", stem: raw`判断：\(-\dfrac{3}{4}\) 是否属于 \(\mathbb{Q}\)？`, answer: raw`属于 \(\mathbb{Q}\)。`, pairWith: "M1-04-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-05", role: "variant", stem: raw`判断：\(C=\{a,a,b\}\) 与 \(D=\{a,b\}\) 是否表示同一个集合。`, answer: raw`是，表示同一个集合。`, pairWith: "M1-05-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-06", role: "variant", stem: raw`用列举法写出方程 \(x^2=9\) 的解集。`, answer: raw`\(\{-3,3\}\)`, pairWith: "M1-06-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-07", role: "variant", stem: raw`用描述法表示"所有负整数"组成的集合。`, answer: raw`\(\{x\in \mathbb{Z}\mid x<0\}\)`, pairWith: "M1-07-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-08", role: "variant", stem: raw`把 \(B=\{x\in\mathbb{Z}\mid 1<x\le 4\}\) 写成列举法。`, answer: raw`\(\{2,3,4\}\)`, pairWith: "M1-08-boundary-1", source: "初诊首批·人工审", reviewed: true },

  // --- M1-09 ---
  { nodeId: "M1-09", role: "boundary", stem: raw`设 \(A=\{1,2\},\ B=\{1,2,3\}\)，判断 \(A\subseteq B\) 是否成立。`, answer: raw`成立。`, source: "初诊首批·人工审", reviewed: true },
  { nodeId: "M1-09", role: "variant", stem: raw`设 \(A=\{1,5\},\ B=\{1,2,3,4\}\)，判断 \(A\subseteq B\) 是否成立。`, answer: raw`不成立。`, pairWith: "M1-09-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-10", role: "variant", stem: raw`设 \(A=\{0,1\},\ B=\{x\in\mathbb{Z}\mid 0\le x\le 1\}\)，判断 \(A=B\) 是否成立。`, answer: raw`成立。`, pairWith: "M1-10-boundary-1", source: "初诊首批·人工审", reviewed: true },

  // --- M1-11 ---
  { nodeId: "M1-11", role: "boundary", stem: raw`求 \([0,2]\cap[1,3]\)。`, answer: raw`\([1,2]\)`, source: "初诊首批·人工审", reviewed: true },
  { nodeId: "M1-11", role: "variant", stem: raw`求 \([-1,1]\cap(0,2]\)。`, answer: raw`\((0,1]\)`, pairWith: "M1-11-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-12", role: "variant", stem: raw`求 \((-\infty,1)\cup[1,4)\)。`, answer: raw`\((-\infty,4)\)`, pairWith: "M1-12-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-13", role: "variant", stem: raw`已知全集 \(U=\mathbb{R}\)，\(B=[-1,1]\)，求 \(U\setminus B\)。`, answer: raw`\((-\infty,-1)\cup(1,+\infty)\)`, pairWith: "M1-13-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-14", role: "variant", stem: raw`数轴上阴影部分表示所有满足 \(-2\le x<1\) 的实数，用区间表示这个集合。`, answer: raw`\([-2,1)\)`, pairWith: "M1-14-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-15", role: "variant", stem: raw`在实数范围内，设 \(p:x=5\)，\(q:x^2=25\)。判断 \(p\) 是 \(q\) 的什么条件。`, answer: raw`\(p\) 是 \(q\) 的充分不必要条件。`, pairWith: "M1-15-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-16", role: "variant", stem: raw`命题"所有实数 \(x\) 都满足 \(x^2\ge 0\)"属于哪类命题？`, answer: raw`全称量词命题。`, pairWith: "M1-16-boundary-1", source: "初诊首批·人工审", reviewed: true },

  // --- M1-17 ---
  { nodeId: "M1-17", role: "boundary", stem: raw`命题"存在 \(x\in\mathbb{R}\)，使 \(x^2=9\)"属于哪类命题？`, answer: raw`存在量词命题。`, source: "初诊首批·人工审", reviewed: true },
  { nodeId: "M1-17", role: "variant", stem: raw`命题"至少有一个实数 \(x\) 使 \(x+2=0\)"属于哪类命题？`, answer: raw`存在量词命题。`, pairWith: "M1-17-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-24", role: "variant", stem: raw`用图象法解不等式：\(x^2-9>0\)。`, answer: raw`\((-\infty,-3)\cup(3,+\infty)\)`, pairWith: "M1-24-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-25", role: "variant", stem: raw`已知二次函数 \(f(x)\) 的图象开口向上，并且与 \(x\) 轴交于 \(x=-2\) 和 \(x=3\)。直接写出 \(f(x)<0\) 的解集。`, answer: raw`\((-2,3)\)`, pairWith: "M1-25-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-26", role: "variant", stem: raw`已知 \(z=3\)。写出它的实部、虚部，并判断它属于实数、纯虚数还是非实复数。`, answer: raw`实部为 \(3\)，虚部为 \(0\)，它是实数。`, pairWith: "M1-26-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-27", role: "variant", stem: raw`若 \(m-5i=4+ni\)，求 \(m,n\)。`, answer: raw`\(m=4,\ n=-5\)。`, pairWith: "M1-27-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-28", role: "variant", stem: raw`复数 \(z=-1+i\) 在复平面内对应点 \(Q\)，写出 \(Q\) 的坐标。`, answer: raw`\(Q(-1,1)\)`, pairWith: "M1-28-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-29", role: "variant", stem: raw`计算 \((5-i)-(2-3i)\)，并把结果写成 \(a+bi\) 形式。`, answer: raw`\(3+2i\)`, pairWith: "M1-29-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "M1-30", role: "variant", stem: raw`计算 \(\dfrac{2+2i}{1-i}\)，并化成 \(a+bi\) 形式。`, answer: raw`\(2i\)`, pairWith: "M1-30-boundary-1", source: "初诊首批·人工审", reviewed: true },
  ...
  { nodeId: "BG100", role: "variant", stem: raw`已知 \(x^2+3x-4=0\)，写出两根之和与两根之积。`, answer: raw`两根之和为 \(-3\)，两根之积为 \(-4\)。`, pairWith: "BG100-boundary-1", source: "初诊题产出·人工审", reviewed: true },
  ...
  { nodeId: "BG101", role: "variant", stem: raw`解不等式 \((x+1)(x-3)>0\)。`, answer: raw`解集为 \((-\infty,-1)\cup(3,+\infty)\)。`, pairWith: "BG101-boundary-1", source: "初诊题产出·人工审", reviewed: true },
  ...
  { nodeId: "BG102", role: "variant", stem: raw`把集合 \(\{x\mid 0<x\le 5\}\) 写成区间。`, answer: raw`\((0,5]\)。`, pairWith: "BG102-boundary-1", source: "初诊题产出·人工审", reviewed: true },
  ...
  { nodeId: "BG103", role: "variant", stem: raw`设 \(t=x^2\)，把方程 \(x^4-13x^2+36=0\) 化为关于 \(t\) 的方程。`, answer: raw`\(t^2-13t+36=0\)。`, pairWith: "BG103-boundary-1", source: "初诊题产出·人工审", reviewed: true },
  ...
  { nodeId: "BG104", role: "variant", stem: raw`求函数 \(y=x^2-4x+1\) 在闭区间 \([1,4]\) 上的最小值和最大值。`, answer: raw`最小值为 \(-3\)，最大值为 \(1\)。`, pairWith: "BG104-boundary-1", source: "初诊题产出·人工审", reviewed: true },
  ...
  { nodeId: "M2a-03", role: "variant", stem: raw`求函数 \(f(x)=\dfrac{\sqrt{x+3}}{x-1}\) 的定义域。`, answer: raw`定义域为 \([-3,1)\cup(1,+\infty)\)。`, pairWith: "M2a-03-boundary-1", source: "初诊题产出·人工审", reviewed: true },
  ...
  { nodeId: "M2a-04", role: "variant", stem: raw`已知 \(f(x)=x^2+1\)，求 \(f(3)\)。`, answer: raw`\(f(3)=3^2+1=10\)。`, pairWith: "M2a-04-boundary-1", source: "初诊题产出·人工审", reviewed: true },
  ...
  { nodeId: "M2a-09", role: "variant", stem: raw`已知 \(f(x)=\begin{cases}x-1,&x<1\\x+2,&x\ge 1\end{cases}\)，求 \(f(4)\)。`, answer: raw`因为 \(4\ge 1\)，所以取第二段，\(f(4)=4+2=6\)。`, pairWith: "M2a-09-boundary-1", source: "初诊题产出·人工审", reviewed: true },
  ...
  { nodeId: "M2a-17", role: "variant", stem: raw`判断函数 \(f(x)=x^2+1\) 的奇偶性。`, answer: raw`\(f(-x)=(-x)^2+1=x^2+1=f(x)\)，所以 \(f(x)\) 是偶函数。`, pairWith: "M2a-17-boundary-1", source: "初诊题产出·人工审", reviewed: true },
  ...
  { nodeId: "M2a-32", role: "variant", stem: raw`比较 \(2^{-3}\) 与 \(2^{-1}\) 的大小。`, answer: raw`因为底数 \(2>1\)，且 \(-3<-1\)，所以 \(2^{-3}<2^{-1}\)。`, pairWith: "M2a-32-boundary-1", source: "初诊题产出·人工审", reviewed: true },
  ...
  { nodeId: "M2a-38", role: "variant", stem: raw`化简并求值 \(\log_5 5+\log_5 25\)。`, answer: raw`\(\log_5 5+\log_5 25=\log_5(5\cdot 25)=\log_5 125=3\)。`, pairWith: "M2a-38-boundary-1", source: "初诊题产出·人工审", reviewed: true },
  ...
  { nodeId: "M2a-42", role: "variant", stem: raw`比较 \(\log_2 7\) 与 \(\log_2 3\) 的大小。`, answer: raw`因为底数 \(2>1\)，且 \(7>3\)，所以 \(\log_2 7>\log_2 3\)。`, pairWith: "M2a-42-boundary-1", source: "初诊题产出·人工审", reviewed: true },
