                  ...
                  return (
                    <li key={node.nodeId}>
                      <button
                        ...
                        className="flex w-full items-center gap-2.5 rounded-xl border border-[#EFE8DD] bg-white px-3 py-2.5 text-left transition-colors hover:border-[#D9D1C3] active:scale-[0.98]"
                      >
                        {/* 色点 */}
                        <span
