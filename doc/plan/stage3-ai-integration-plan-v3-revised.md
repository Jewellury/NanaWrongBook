...
- 题图缩略图固定宽度（如 200px），缩略、弱化，不占太大空间
- 字号适配 A4 纸
...
| 排查项 | 检查内容 |
|--------|---------|
| 保存后状态展示 | 保存成功后如何展示"正在整理这题…"，轮询机制 |
| 30 秒等待反馈 | 等待期间给什么反馈（进度条？动画？纯文字？） |
| 异步整理选项 | 是否允许"题已收好，先拍下一道，稍后看整理结果"——v1 需确认是否支持 |
...
9. ⬜ **异步整理选项确认**：拍题后是否允许"先拍下一道，稍后看整理结果"——待产品确认
